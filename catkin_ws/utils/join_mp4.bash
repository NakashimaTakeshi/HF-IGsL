...
# # 2 つの動画を横に並べる
# Filename_left=validation_ep0_predict_pose_2023_0410_142148.mp4
# Filename_right=validation_ep0_predict_pose_2023_0410_155632.mp4
# ffmpeg -y -i ${Filename_left} -i ${Filename_right} -filter_complex "[0:v][1:v]hstack" out.mp4

Filename_upper=validation_ep0_predict_pose_2023_0410_142148.mp4
Filename_lower=validation_ep0_predict_pose_2023_0411_101817.mp4
ffmpeg -y -i ${Filename_upper} -i ${Filename_lower} -filter_complex "[0:v][1:v]vstack" out.mp4
