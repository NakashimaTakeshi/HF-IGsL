...
do
    ...
    rosbag filter ${bag} $(basename "${bag}" .bag)_filtered.bag "topic != '/amcl_pose' and topic != '/particlecloud' and (topic != '/tf' or (len(m.transforms)>0 and m.transforms[0].child_frame_id=='base_footprint'))"
