...
class WordPublisher ():
    def __init__(self, world):
        ...
        self.kitchenDict = {'1': 'i heard something crashing in the kitchen in the middle of the night', '2': 'mother is in the kitchen',
         ...
         '5': 'they are talking in the kitchen', '6': 'we were cooking tempura at that time', '7': 'mother hummed to herself as she went about her cooking',
         '8': 'she finished up lunch with coffee', '9': 'opening the refrigerator, I noticed the meat had spoiled', '10': 'nothing remained in the refrigerator'}

        self.livingRoomDict = {'1': 'the living room adjoins the dining room', '2': 'the living room in my new house is very large',
         '3': 'father made our living room more spacious', '4': 'one Sunday morning George burst into the living room and said the following', '5': 'our living room is sunny',
         '6': 'she put the blanket over the child sleeping on the sofa', '7': 'as he was tired, he was lying on the sofa with his eyes closed', '8': 'i am tired of watching television',
         '9': 'my father usually watches television after dinner', '10': 'there is a dictionary on the desk'}

        self.bedroomDict = {'1': 'i went up to my bedroom on tiptoe', '2': 'i have my own bedroom at home', '3': 'i found myself lying in my bedroom',
         '4': 'i share a bedroom with my sister', '5': 'i like to have a full-length mirror in my bedroom', '6': 'to be a good child, you need to go to bed and get up early', 
